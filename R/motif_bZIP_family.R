...
tfs <- read.csv('data/bZIP_tnt_tfs.csv', col.names = 'TF')
pred_motifs <- h5read('data/bZIP_tnt_predictive_motifs.h5', name = "motifs")
...
svg(filename = 'results/Figures/bZIP_family_motifs_clustered_tree.svg')
