...
tfs <- read.csv('data/bHLH_tnt_tfs.csv', col.names = 'TF')
pred_motifs <- h5read('data/bHLH_tnt_predictive_motifs.h5', name = "motifs")
...
svg(filename = 'results/Figures/bHLH_family_motifs_clustered_tree.svg')
